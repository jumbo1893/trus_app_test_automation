...
public class NegativeRegistrationTests extends BaseClass {
    ...
    public void invalidRegistrationTest() {
        ...
        RegistrationPage nextPage = loginPage
                .clickRegister()
    ...
    public void noNameRegistrationTest() {
        ...
        RegistrationPage nextPage = loginPage
                .clickRegister()
                .fillPassword(LoginPage.VALID_USER_PASSWORD)
    ...
    public void invalidMailFormatLoginTest() {
        ...
        RegistrationPage nextPage = loginPage
                .clickRegister()
                .negativeSignUp(LoginPage.INVALID_FORMAT_USER, LoginPage.VALID_USER_PASSWORD);
